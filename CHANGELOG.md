...
## [0.50.0](https://github.com/theurzil/kaunta/compare/v0.52.2...v0.50.0) (2026-02-22)
...
* add arm64 pi docs and builds ([478a3f5](https://github.com/theurzil/kaunta/commit/478a3f52ffbd34fba03237c33d3a248106aa28d1))
* add automated install script for Unix platforms ([9f2f2e2](https://github.com/theurzil/kaunta/commit/9f2f2e235cb884b87a1d7406415b42624d9729c5))
* add binary build and Docker push to release-please workflow ([102e696](https://github.com/theurzil/kaunta/commit/102e69667da952a8c1c090d32d4ca912c6484f5e))
* add branding, favicon, and Open Graph meta tags ([#48](https://github.com/theurzil/kaunta/issues/48)) ([337e3be](https://github.com/theurzil/kaunta/commit/337e3bec085f37e65dad25f08b4076e91e83a0cb))
* Add comprehensive CLI for website and analytics management ([d8239ce](https://github.com/theurzil/kaunta/commit/d8239ceb2d92744464134eb3d0aa6888cdeed230))
* add CSRF protection and rate limiting to login endpoint ([e922c80](https://github.com/theurzil/kaunta/commit/e922c80e81c0dfdc6b9128867d1612d49161ca23))
* add CSRF token cleanup on logout ([3909531](https://github.com/theurzil/kaunta/commit/39095319698648cdb56d2d8ecd9974ea52e8330b))
* add dashboard icons and OS breakdown ([#83](https://github.com/theurzil/kaunta/issues/83)) ([3473a2f](https://github.com/theurzil/kaunta/commit/3473a2fc1bda99fcc0668bd378a8ad061449fcb4))
* add doctor CLI command for health checks ([#80](https://github.com/theurzil/kaunta/issues/80)) ([03ea0ef](https://github.com/theurzil/kaunta/commit/03ea0efaab3540b2c7e0e22beccc3c1d60ca7ed3))
* add entry/exit page tracking with dashboard tabs ([#77](https://github.com/theurzil/kaunta/issues/77)) ([d4f3b0f](https://github.com/theurzil/kaunta/commit/d4f3b0f19963cdff4c36ff8823492f79c478f2fa))
* add FreeBSD build support with Deno fallback ([5c93afb](https://github.com/theurzil/kaunta/commit/5c93afb39783056fd8599b5d993868128bb909cc)), closes [#47](https://github.com/theurzil/kaunta/issues/47)
* add goals CRUD API ([#91](https://github.com/theurzil/kaunta/issues/91)) ([913851a](https://github.com/theurzil/kaunta/commit/913851a456ab53505f93eede8c099fdc5786b769))
* add pagination support to list endpoints ([47aa232](https://github.com/theurzil/kaunta/commit/47aa23244c4e0380fa411d271b6bcc87382a9742))
* add pixel tracking endpoint for email and RSS analytics ([#81](https://github.com/theurzil/kaunta/issues/81)) ([5908e42](https://github.com/theurzil/kaunta/commit/5908e429013a04ed4aeab19f3c7e5c9ea4554b03))
* add public stats API with dashboard toggle ([#120](https://github.com/theurzil/kaunta/issues/120)) ([5af613a](https://github.com/theurzil/kaunta/commit/5af613a8e0a63944227acea788912bac34ffa85e))
* add real-time WebSocket updates and fix dashboard filters ([fb739a4](https://github.com/theurzil/kaunta/commit/fb739a4d84529c5737ff74d2346175a5e609c198))
* add self-update functionality ([4a07c66](https://github.com/theurzil/kaunta/commit/4a07c660dcf5b0fe3608f31604e6cd15ca4dc9f3))
* add server-side ingest API for backend event tracking ([#121](https://github.com/theurzil/kaunta/issues/121)) ([6d7b1d8](https://github.com/theurzil/kaunta/commit/6d7b1d86f91c6b5bfd27684554106b209c23c38b))
* add sorting support to analytics endpoints ([#75](https://github.com/theurzil/kaunta/issues/75)) ([0c7f2cc](https://github.com/theurzil/kaunta/commit/0c7f2cc9133932256185f211c3231d7b667819b3))
* add test files and CLI improvements ([f8002a9](https://github.com/theurzil/kaunta/commit/f8002a9157ef460a59b2ad2ec71c75e28e3e4002))
* add TOML config file support ([1f1cb4b](https://github.com/theurzil/kaunta/commit/1f1cb4b13fdc86ab108c6ded3fcc0921b9289987))
* add trusted origins config sync and non-interactive password reset ([4a14e36](https://github.com/theurzil/kaunta/commit/4a14e365efebbd34f98e6c67343e20262aac8c0d))
* add username-based authentication system ([75cf106](https://github.com/theurzil/kaunta/commit/75cf106fa05a9b6e84e46525ee4af988c8eed780))
* add UTM campaign parameter tracking ([#76](https://github.com/theurzil/kaunta/issues/76)) ([c9326f1](https://github.com/theurzil/kaunta/commit/c9326f11cee52057d12023171121b75fcbe417d0))
* add web-based setup wizard for initial configuration ([#64](https://github.com/theurzil/kaunta/issues/64)) ([602d658](https://github.com/theurzil/kaunta/commit/602d65849fa313e072eca68ad422201a8039dd95))
* add website management dashboard UI ([#78](https://github.com/theurzil/kaunta/issues/78)) ([1201025](https://github.com/theurzil/kaunta/commit/12010257f3982834cc90b357c1c0a28626226563))
* **auth:** add redirect middleware and fix CSRF configuration ([#20](https://github.com/theurzil/kaunta/issues/20)) ([5509b40](https://github.com/theurzil/kaunta/commit/5509b40a23e68b117b4be555f798cd038b654f81))
* auto-allow domain variations on website creation ([ed62618](https://github.com/theurzil/kaunta/commit/ed6261899e9c2955e7129cd90e4dffebef6b359d))
* cleaner trusted origin ([183932c](https://github.com/theurzil/kaunta/commit/183932c4de7dcb227f39ccabb322a6f8563d6181))
* create dedicated map page with TopoJSON integration ([28266f8](https://github.com/theurzil/kaunta/commit/28266f84b156f6fb2a6be580e7a81c0fe91fbe9b))
* create dedicated map page with TopoJSON integration ([d857286](https://github.com/theurzil/kaunta/commit/d857286fb7b026f1e8e36bc8b98b8d4725250609))
* dictator datastar decree ([#127](https://github.com/theurzil/kaunta/issues/127)) ([fe63971](https://github.com/theurzil/kaunta/commit/fe639712678b92cc8ae904e0d494e3e4fe3ef013))
* enable prefork mode for bare metal, disable for Docker ([db1ad7e](https://github.com/theurzil/kaunta/commit/db1ad7ef21198d0db47f0788f11ca13b90f751ff))
* fix defer/async script loading and add Playwright tests ([d15c82f](https://github.com/theurzil/kaunta/commit/d15c82f0cc9ee4a5af40a9d9f831cf5f6093e13b))
* fix tracker initialization and dynamic ETag generation ([f359c1e](https://github.com/theurzil/kaunta/commit/f359c1eebe192c2cb282e1689908ca7e75793bb5))
* **goals:** implement goals ui and fix dashboard styling ([#99](https://github.com/theurzil/kaunta/issues/99)) ([7e91097](https://github.com/theurzil/kaunta/commit/7e910976e9efadee18da1ba166a5fd10a65f3a1d))
* implement Fiber template engine with layout system ([6c0ef3d](https://github.com/theurzil/kaunta/commit/6c0ef3d71447cb48060bef122d7c755da8fadec0))
* implement goal tracking with analytics dashboard ([64e474f](https://github.com/theurzil/kaunta/commit/64e474fc2f80503bb57d12433a9e336e19e679c9))
* improve Docker workflow and fix dashboard issues ([37474b0](https://github.com/theurzil/kaunta/commit/37474b0e41eabc9b774944de9796fa0f53e626a1))
* improve websites cards design ([#106](https://github.com/theurzil/kaunta/issues/106)) ([b3b3537](https://github.com/theurzil/kaunta/commit/b3b35371426e3374d06835da7343eebaeae4bd6a))
* invalidate css cache ([46be55a](https://github.com/theurzil/kaunta/commit/46be55a9fef29a6f1fe9da7fe49c495f4c57b097))
* migrate analytics queries to PostgreSQL functions ([d85734f](https://github.com/theurzil/kaunta/commit/d85734f84cb8f949bdb471c33a7dc6839a77f3c7))
* migrate backend from Fiber to Chi ([f234fd9](https://github.com/theurzil/kaunta/commit/f234fd975381fa1bda3b14ba624689e5303a923f))
* migrate backend from Fiber to Chi ([#140](https://github.com/theurzil/kaunta/issues/140)) ([c409fb7](https://github.com/theurzil/kaunta/commit/c409fb7ecc9a8d2bfa396804a66cf90be4a7a58f))
* migrate backend from Fiber to Chi ([#141](https://github.com/theurzil/kaunta/issues/141)) ([f234fd9](https://github.com/theurzil/kaunta/commit/f234fd975381fa1bda3b14ba624689e5303a923f))
* move password verification to Go-side bcrypt ([#85](https://github.com/theurzil/kaunta/issues/85)) ([a0fe6ab](https://github.com/theurzil/kaunta/commit/a0fe6ab8928d9b0672685fd16d7c6ff3e12d3f5b))
* optimize tracker with rAF scroll batching, ResizeObserver, sendBeacon, AbortController cleanup, and test infrastructure ([105511e](https://github.com/theurzil/kaunta/commit/105511ed828a70fa833479e6683a55674cff63e2))
* redesign home page and dashboard ([#9](https://github.com/theurzil/kaunta/issues/9)) ([95fc376](https://github.com/theurzil/kaunta/commit/95fc376d07b1b82e85a89a2fe24346ff35bd7460))
* redesign setup and setup_complete ui ([#108](https://github.com/theurzil/kaunta/issues/108)) ([6f120be](https://github.com/theurzil/kaunta/commit/6f120be61985ac4ba57803be2b13a05ff19adbc2))
* redesign the login page ([#10](https://github.com/theurzil/kaunta/issues/10)) ([de2dccb](https://github.com/theurzil/kaunta/commit/de2dccbd49d9b874335c8eb8f639991bcd8f37bd))
* replace Alpine.js with Datastar for SSE-driven dashboard ([#124](https://github.com/theurzil/kaunta/issues/124)) ([080ae70](https://github.com/theurzil/kaunta/commit/080ae70908e29fb0303fafecd3a8f6690b205de7))
* replace go-github-selfupdate with contriboss/go-update ([#129](https://github.com/theurzil/kaunta/issues/129)) ([ec8cf39](https://github.com/theurzil/kaunta/commit/ec8cf398925119891a592045f549fd025e0d59a9))
* show path of referrer int he dashboard ([38d9f22](https://github.com/theurzil/kaunta/commit/38d9f22919c7fb39b61b3673831135210ecd3a09))
* switch zap logger ([ed62618](https://github.com/theurzil/kaunta/commit/ed6261899e9c2955e7129cd90e4dffebef6b359d))
* upgrade Fiber from v2 to v3 ([1898909](https://github.com/theurzil/kaunta/commit/189890980f1f36a319985f34908760684f1da0b5))
* upgrade to PostgreSQL 18 with UUIDv7 and virtual columns ([#126](https://github.com/theurzil/kaunta/issues/126)) ([ff0257a](https://github.com/theurzil/kaunta/commit/ff0257a17aa5e6d00e062d82b6061fa2c05f5fd8))
* Use XDG paths. ([#60](https://github.com/theurzil/kaunta/issues/60)) ([321866d](https://github.com/theurzil/kaunta/commit/321866de3bfc3df67b3fc590340646b328a3b178))


### Bug Fixes

* add /up health check endpoint to setup wizard server ([5195507](https://github.com/theurzil/kaunta/commit/51955074e3e8f66259e34dc31b68f470e1a01e25))
* add assets ([2f0390f](https://github.com/theurzil/kaunta/commit/2f0390f56f5be26798ef5659df40cd77df2c4aed))
* add checkout step to upload-release-assets job ([63ffe95](https://github.com/theurzil/kaunta/commit/63ffe9506472d133ea635b176348a4b8f057dfc7))
* add credentials include to login fetch ([c88e498](https://github.com/theurzil/kaunta/commit/c88e498efcc0f140e520405522a31733ad33bd33))
* add datastar.js vendor file (was globally gitignored) ([54e4d96](https://github.com/theurzil/kaunta/commit/54e4d96c316ec3ab754c84a55bb30dc3126b227d))
* add debug ([3befb5c](https://github.com/theurzil/kaunta/commit/3befb5c5f000473870a95daf3bf4dc633cfcfc28))
* add POST to CORS allowed methods for tracking API ([3825051](https://github.com/theurzil/kaunta/commit/3825051635d34d145465274c2e3c4dc196a34730))
* Alpine.js duplicate key errors and filter data extraction ([605201b](https://github.com/theurzil/kaunta/commit/605201b51003950756369b380f4a8c237be9315d))
* auto-detect HTTPS via reverse proxy headers ([11aea35](https://github.com/theurzil/kaunta/commit/11aea35a3b1b1dea021f605bd2933898aa7217ff))
* auto-regenerate migration version during build ([97d6608](https://github.com/theurzil/kaunta/commit/97d6608edf765e4a82db3153c1b600b4bdd70c68))
* build ([45ad174](https://github.com/theurzil/kaunta/commit/45ad17412cd9556f62fafe7f0be56a330a292713))
* bump version ([6af73b2](https://github.com/theurzil/kaunta/commit/6af73b2fe4d135ae4265bf74d6087a85f312b8cf))
* cookie SameSite policy for HTTPS proxy compatibility ([cf2dad5](https://github.com/theurzil/kaunta/commit/cf2dad50a4db5c1c5a79d854b9bc8c709909d349))
* create global CSS file and optimize styles ([#71](https://github.com/theurzil/kaunta/issues/71)) ([04ef718](https://github.com/theurzil/kaunta/commit/04ef71886bd512a7e1e8286071faefdf1f492ad9))
* Critical production bugs and linter compliance ([1528ff5](https://github.com/theurzil/kaunta/commit/1528ff5ffb056c8231a90bb945af5461dfaf1932))
* CSRF KeyLookup format for Fiber v2.52.9 compatibility ([3875f29](https://github.com/theurzil/kaunta/commit/3875f298bd205aa99fad08d361a48610aec3f28e))
* **dashboard:** resolve chart rendering race condition ([#16](https://github.com/theurzil/kaunta/issues/16)) ([5468140](https://github.com/theurzil/kaunta/commit/54681407388b06a21b836c16bf9f1087034f12ba))
* derive migration version at build time ([#94](https://github.com/theurzil/kaunta/issues/94)) ([9b7828c](https://github.com/theurzil/kaunta/commit/9b7828c8e57044ce5726346bb553c9ef1a63e8ed))
* disable secure cookies in docker-compose for local dev ([cfb4a67](https://github.com/theurzil/kaunta/commit/cfb4a67a3563439ef027000acc92515e426da19b))
* enable CORS credentials for cookie auth ([f0a9fbb](https://github.com/theurzil/kaunta/commit/f0a9fbb5c6db77eab1366803e0712e0a6a52b7cb))
* extract css and js ([#100](https://github.com/theurzil/kaunta/issues/100)) ([6a091f9](https://github.com/theurzil/kaunta/commit/6a091f9f7d056df3480c8777035dfcb1ac965382))
* extract index outside ([f9b178b](https://github.com/theurzil/kaunta/commit/f9b178b617005818e8e0321a0bfc94e6cd4f891c))
* fix dashboard pages rendering ([#112](https://github.com/theurzil/kaunta/issues/112)) ([343bbf5](https://github.com/theurzil/kaunta/commit/343bbf56ef418b658797bcb1434b27a2ae6a5737))
* fix null constraint ([dce56a5](https://github.com/theurzil/kaunta/commit/dce56a5bab56cce34390f2695f72968e3c77a0f2)), closes [#103](https://github.com/theurzil/kaunta/issues/103)
* fix release ([2d17b10](https://github.com/theurzil/kaunta/commit/2d17b107cb7684819ca22539fd628421a4475d49))
* handle empty IP address in session creation ([7ad61cc](https://github.com/theurzil/kaunta/commit/7ad61cc87c5510b06608360c26fd485c6f6680da))
* hide self-upgrade flags in dev builds ([2a9effb](https://github.com/theurzil/kaunta/commit/2a9effb62fed661c8c65919865eddf3d1fd1ed66))
* http support ([c10bfb5](https://github.com/theurzil/kaunta/commit/c10bfb5d730b9c8b4124fa54b282db944c60b05e))
* improve Docker healthcheck to test service health ([4421b76](https://github.com/theurzil/kaunta/commit/4421b7657fabc74ca85ffc32266695667178cf00))
* improve map initialization with proper cleanup and retry logic ([#68](https://github.com/theurzil/kaunta/issues/68)) ([f29989f](https://github.com/theurzil/kaunta/commit/f29989f55dfbf0c44ee7a2b1156a1aa296220fd3))
* include credentials in login fetch request for CSRF validation ([dde02c9](https://github.com/theurzil/kaunta/commit/dde02c955c4a1d5016a86450d7d9b824f817c061))
* init release ([609243d](https://github.com/theurzil/kaunta/commit/609243d96ec01a323d3c645bc7d8a634ca135012))
* inject version into Docker binary via ldflags ([d920959](https://github.com/theurzil/kaunta/commit/d9209599654a77dba4f0066b2eec3ac0b3960280))
* introduce structured logging ([2d71501](https://github.com/theurzil/kaunta/commit/2d715015c32c7804d0aa0b34945e55d9feccb9d7))
* make CSRF cookies work without HTTPS ([c192422](https://github.com/theurzil/kaunta/commit/c19242232e5a2d5dade8d009f92599643f94fbe8))
* move binary to /usr/local/bin and add Docker user management docs ([40fab37](https://github.com/theurzil/kaunta/commit/40fab370bdca76adf866467325dc797e58fa172d)), closes [#53](https://github.com/theurzil/kaunta/issues/53)
* preserve HTTPS scheme in TRUSTED_ORIGINS config ([#88](https://github.com/theurzil/kaunta/issues/88)) ([270f4a3](https://github.com/theurzil/kaunta/commit/270f4a30b19ff29f4886d0cf1df5ee7b5548d3d3))
* prevent Chart.js error on hidden canvas ([16a7bd4](https://github.com/theurzil/kaunta/commit/16a7bd42148cec12499cda34a623af7be3928e6e))
* prevent map() error on undefined timeseriesData in goals analytics ([#117](https://github.com/theurzil/kaunta/issues/117)) ([9cce649](https://github.com/theurzil/kaunta/commit/9cce649eef4e835b925b14f72933c2f58199f930))
* push fixing migration ([ea1923e](https://github.com/theurzil/kaunta/commit/ea1923e69a95ff135b219a79f0ab331fe58c2ec7))
* read CSRF token from cookie instead of server injection ([9de7b4c](https://github.com/theurzil/kaunta/commit/9de7b4c477a6d985d0643e2357e9a97c9979dec7))
* reload config and set environment vars after setup wizard completes ([594f1fc](https://github.com/theurzil/kaunta/commit/594f1fcba1881caf0c0437f0fc09e40ba3ebe17a))
* Remove broken tests.yml and add linting to test.yml ([7f2f1af](https://github.com/theurzil/kaunta/commit/7f2f1aff106544d8ff4b523dd883e0d389c0aab7))
* remove redundant CSRF endpoint and consolidate Fiber config ([5e43fe4](https://github.com/theurzil/kaunta/commit/5e43fe44b1f1c915d168a6687bf722a0823d8f57))
* render empty chart and fix null array responses ([399228f](https://github.com/theurzil/kaunta/commit/399228fb7a4bee802b44c1945af78f6eb40a2c02))
* replace alpine setup with datastar ([1bb7a97](https://github.com/theurzil/kaunta/commit/1bb7a97b19878a02684daa80d42eb02d5ac3d4b3))
* resolve datastar frontend issues ([#135](https://github.com/theurzil/kaunta/issues/135)) ([78bab4f](https://github.com/theurzil/kaunta/commit/78bab4f882a5cfea4a857813ba487d08f9cb5c2e))
* resolve race conditions in realtime package ([23648c1](https://github.com/theurzil/kaunta/commit/23648c13f161f98348efe09cd847e8f392c16e41))
* resolve tracking endpoint failures - CHAR(2) country column constraint ([be074b9](https://github.com/theurzil/kaunta/commit/be074b91a06822358fe13540b91dd172f8a4fe57))
* restore analytics modal and update actions buttons ui ([#138](https://github.com/theurzil/kaunta/issues/138)) ([78f26a2](https://github.com/theurzil/kaunta/commit/78f26a2f9a715b882707e8fdec55f95a1fb7698d))
* restore setup actions after datastar upgrade ([#132](https://github.com/theurzil/kaunta/issues/132)) ([4be3f64](https://github.com/theurzil/kaunta/commit/4be3f64fe3e6ad4d6d24572aaf00a5883a038338))
* safe type assertion for CSRF token extraction ([8976454](https://github.com/theurzil/kaunta/commit/8976454a6a21eb2ea88fffdeb04a97066802e45b))
* sanitize trusted origins and enforce constraint ([#93](https://github.com/theurzil/kaunta/issues/93)) ([3ef8391](https://github.com/theurzil/kaunta/commit/3ef8391f229df4b50ce5c777e271476253411437))
* self-upgrade runs before database validation ([6240c5e](https://github.com/theurzil/kaunta/commit/6240c5e1a4a90e7de75ff309b05a570a902f3e30))
* Show full website IDs in table format instead of truncated ([55cc9f8](https://github.com/theurzil/kaunta/commit/55cc9f83d1cc09316c0581017afda5fb2d784fe3))
* skip CSRF for static assets (JS/CSS) to prevent cross-site cookie rejection ([#63](https://github.com/theurzil/kaunta/issues/63)) ([99a279a](https://github.com/theurzil/kaunta/commit/99a279a1796955898d0eb7feeec35b60fe56341c))
* support migration from Umami v2/v3 databases ([#115](https://github.com/theurzil/kaunta/issues/115)) ([33ba61e](https://github.com/theurzil/kaunta/commit/33ba61e4595d13b0a8d3e1bdaf9ca4c27cd468f6))
* tag generation ([260226d](https://github.com/theurzil/kaunta/commit/260226d2f4282530022be02c22bb4d8d8340e402))
* test ci ([b9c8618](https://github.com/theurzil/kaunta/commit/b9c8618fbbffacc012852892d1cc54ad0c42857a))
* tidy go module dependencies ([3c9383f](https://github.com/theurzil/kaunta/commit/3c9383f7167b073ea2d9da00482147a331edfac7))
* **ui:** standardize modals, empty states, and layouts across all pages ([#137](https://github.com/theurzil/kaunta/issues/137)) ([d11ffd8](https://github.com/theurzil/kaunta/commit/d11ffd879ebb45c492b1e5df69ae5273ed14e6c0))
* update GeoIP database URL and clean up version API response ([79ae811](https://github.com/theurzil/kaunta/commit/79ae811bb3e6bc9b1150858d086d3ae34aed7545))
* update js to remove defensive code ([289a29d](https://github.com/theurzil/kaunta/commit/289a29d458d273ef4dcb0bf2001633932d083ed2))
* update release workflow for self-upgrade support ([95d14db](https://github.com/theurzil/kaunta/commit/95d14db9a5c3b46ad246e666a0525899ef7bf899))
* use AllowOriginsFunc for CORS credentials ([ae5a2b7](https://github.com/theurzil/kaunta/commit/ae5a2b7dc683e99f0e7735e147373b9422782e68))
* use bun to compile js ([5d448ef](https://github.com/theurzil/kaunta/commit/5d448ef94870d5024dfd9b24f72b554925e9f717))
* use csrf.TokenFromContext in /api/auth/csrf endpoint ([5ec3e29](https://github.com/theurzil/kaunta/commit/5ec3e29b2da0fdbb30e356ed6248735c7296de00))
* use csrf.TokenFromContext() to properly extract CSRF token ([bb0aaae](https://github.com/theurzil/kaunta/commit/bb0aaae06d413b630bdf43443e33bb8fa2166583))
* use PersistentPreRunE to ensure config file loading works ([f6cf597](https://github.com/theurzil/kaunta/commit/f6cf597722c5fa5a1478abbdc53af1d891ed91f4))
* use SameSite=None for CSRF cookie ([a19600f](https://github.com/theurzil/kaunta/commit/a19600faa65ce16c76d63fc55c344e85883bb977))
* use TRUSTED_ORIGINS env var for CSRF with proxy ([7234f7f](https://github.com/theurzil/kaunta/commit/7234f7f581dbc443d1870e8425a66dcdf2d50f0c))
* use X-Forwarded-For for client IP detection behind reverse proxy ([bcd184c](https://github.com/theurzil/kaunta/commit/bcd184c5d5d5d265ee45e6deefbe8bb43369bf65))
